...
import MerchantTerminalTab from './MerchantTerminalTab';
...
const MerchantUtiAccount: React.FC<MerSetting.UtiAccountProps> = (props) => {
    const [utiAccount, setUtiAccount] = useState<MerSetting.MerchantUtiAccount>(props.utiAccount ?? {});
    const [terminals, setTerminals] = useState<string>(utiAccount.terminals ?? '[]');
    ...
    const onContentChanged = (termString: string) => {
        utiAccount.terminals = termString;
        setTerminals(termString);
    }
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {utiAccount.accountCode && (
                        <TabPane tab="商户终端" key="3">
                            <MerchantTerminalTab
                                terminals={terminals}
                                IsView={false}
                                isModify={true}
                                form={form}
                                onTerminalsChanged={onContentChanged}
                            />
                        </TabPane>
                    )}
                </Tabs>
